...
class AdsAppEngine:
    ...
    def allocate_new_page(self):
        ...
        root.photo1 = ImageTk.PhotoImage(Image.open(self.news_allocation[0].image_path).resize((300, 300), Image.ANTIALIAS))
        self.b1.configure(image=root.photo1)
        root.photo2 = ImageTk.PhotoImage(Image.open(self.news_allocation[1].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b2.configure(image=root.photo2)
        root.photo3 = ImageTk.PhotoImage(Image.open(self.news_allocation[2].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b3.configure(image=root.photo3)
        root.photo4 = ImageTk.PhotoImage(Image.open(self.news_allocation[3].image_path).resize((300, 300), Image.ANTIALIAS))
        self.b4.configure(image=root.photo4)
        root.photo5 = ImageTk.PhotoImage(Image.open(self.news_allocation[4].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b5.configure(image=root.photo5)
        root.photo6 = ImageTk.PhotoImage(Image.open(self.news_allocation[5].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b6.configure(image=root.photo6)
        root.photo7 = ImageTk.PhotoImage(Image.open(self.news_allocation[6].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b7.configure(image=root.photo7)
        root.photo8 = ImageTk.PhotoImage(Image.open(self.news_allocation[7].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b8.configure(image=root.photo8)
        root.photo9 = ImageTk.PhotoImage(Image.open(self.news_allocation[8].image_path).resize((150, 150), Image.ANTIALIAS))
        self.b9.configure(image=root.photo9)
        root.photo10 = ImageTk.PhotoImage(Image.open(self.news_allocation[9].image_path).resize((150, 150), Image.ANTIALIAS))
